            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="fechaNto" class="col-md-4 col-form-label text-md-right">{{ __('Fecha de nacimiento') }}</label>

                            <div class="col-md-6">
                                <input id="fechaNto" type="date" class="form-control{{ $errors->has('fechaNto') ? ' is-invalid' : '' }}" name="fechaNto" value="{{ old('fechaNto') }}" required>
                            </div>
                        </div>
